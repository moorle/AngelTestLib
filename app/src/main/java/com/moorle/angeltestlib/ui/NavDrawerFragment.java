...
public class NavDrawerFragment extends BaseFragment {
    ...
    public static final int NAVDRAWER_ITEM_CHOICE = 0;
    ...
    private static final int[] NAVDRAWER_TITLE_RES_ID = new int[]{
            R.string.navdrawer_item_choice,
            R.string.navdrawer_item_2,
            R.string.navdrawer_item_3,
            R.string.navdrawer_item_4,
    };
    ...
    private void populateNavDrawer() {
        ...
        mNavDrawerItems.add(NAVDRAWER_ITEM_CHOICE);
    ...
    private void goToNavDrawerItem(int itemId) {
        switch (itemId) {
            case NAVDRAWER_ITEM_CHOICE:
                mCurrentSelectedItemId = NAVDRAWER_ITEM_CHOICE;

                changeColorTo(android.R.color.holo_blue_light);
                break;
            case NAVDRAWER_ITEM_2:
                mCurrentSelectedItemId = NAVDRAWER_ITEM_2;

                changeColorTo(R.color.red);
                break;
            case NAVDRAWER_ITEM_3:
                mCurrentSelectedItemId = NAVDRAWER_ITEM_3;

                changeColorTo(R.color.green);
                break;
            case NAVDRAWER_ITEM_4:
                mCurrentSelectedItemId = NAVDRAWER_ITEM_4;

                changeColorTo(R.color.yellow);
                break;
        }
